...
**Answer**
chr, dbl. Represent last names and amount of income
...
**Answer**
counting the number of contributions per day to all campaigns
...
**Answer**
It is a different set of dates and has more contributions. THe contributions rise by day, so it may be cumulative rather than individual counts for each day
...
**Answer**
Added memos for which committee each was added to, and includes the amount donated <dbl>
...
**Answer**
This one still features which groups are donated to, but has more descriptive statistics
### Task 10: 
